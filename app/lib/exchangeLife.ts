...
export type ArcStep = {
  ...
  export const program = {
    displayName: "Exchange Life",
    description:
      "A guided journey into the Exchanged Life — trading our strength for Christ’s life in us.",
  };
  ...
  export const modules: Module[] = [
    {
      ...
      scriptureRefs: ["Galatians 2:20", "Colossians 1:27", "John 15:5"],
      journalPrompts: [
